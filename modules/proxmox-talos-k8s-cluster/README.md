...
| <a name="input_flux_bootstrap_repo"></a> [flux\_bootstrap\_repo](#input\_flux\_bootstrap\_repo) | username/name for the gitea repository with fluxcd setup | <pre>object({<br/>    username = string<br/>    name     = string<br/>    branch   = optional(string, "main")<br/>  })</pre> | n/a | yes |
